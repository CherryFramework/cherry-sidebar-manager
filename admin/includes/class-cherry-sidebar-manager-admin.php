...
class Cherry_Custom_Sidebars_Admin {
	...
	public function add_admin_assets( $hook_suffix ) {
		if($hook_suffix === 'widgets.php'){
			wp_register_script( 'cherry_admin_custom_sidebars_js', trailingslashit( CHERRY_CUSTOM_SIDEBARS_URI ) . 'admin/assets/js/cherry-admin-sidebar-manager.js', array( 'jquery' ), CHERRY_CUSTOM_SIDEBARS_VERSION );
